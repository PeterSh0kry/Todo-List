...
function addTodoItem(){
    ...
    if(selectedIndex >= 0){
        ...
        document.getElementById("todo-btn").classList.remove('edit');
    }else{
...
function editItem(index){
    ...
    document.getElementById("todo-btn").innerHTML = 'Edit';
    document.getElementById("todo-btn").classList.add('edit');
}